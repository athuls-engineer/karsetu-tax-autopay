...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-black text-slate-900 dark:text-white font-sans">
          <div className="max-w-md w-full p-8 rounded-4xl bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-white/[0.08] shadow-m3-4 text-center space-y-6 animate-in fade-in">
            ...
            {this.state.error && (
              <div className="p-3 rounded-2xl bg-slate-100 dark:bg-[#141414] text-left text-[11px] font-mono text-slate-600 dark:text-neutral-400 max-h-24 overflow-y-auto border border-slate-200 dark:border-white/[0.06]">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="py-3 px-4 rounded-2xl bg-slate-100 hover:bg-slate-200 dark:bg-[#181818] dark:hover:bg-[#222222] text-slate-800 dark:text-neutral-200 font-bold text-xs transition-colors cursor-pointer"
              >
                Try Continue
              </button>
            </div>
