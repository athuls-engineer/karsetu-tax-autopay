  ...
  return (
    <div className="relative inline-flex items-center ml-1.5 align-middle">
      <button
        ...
        className="inline-flex items-center gap-1 px-2.5 py-0.5 text-xs font-semibold rounded-full bg-slate-100 dark:bg-[#1E293B] hover:bg-blue-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700 transition-colors"
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute left-0 bottom-full mb-2 w-72 sm:w-80 p-4 bg-white dark:bg-[#0F172A] rounded-2xl shadow-m3-3 border border-slate-200 dark:border-slate-800 z-50 animate-in fade-in zoom-in-95 text-left">
            <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-100 dark:border-slate-800">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="p-1 text-slate-400 hover:text-slate-600 dark:hover:text-white rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="space-y-2 text-xs">
              <div>
                ...
                <p className="text-slate-700 dark:text-slate-200 font-medium leading-relaxed bg-blue-50/70 dark:bg-[#0C1E3D] p-2.5 rounded-xl border border-blue-100/60 dark:border-blue-700/60">
              ...
              {bureaucraticName && (
                <div className="pt-1">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 italic mt-0.5 font-mono">
                    "{bureaucraticName}"
                  </p>
                </div>
              )}
