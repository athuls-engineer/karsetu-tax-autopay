    ...
    <div className="space-y-6 animate-in fade-in">
      ...
      <div className="bg-white dark:bg-[#0A0A0A] rounded-4xl p-6 sm:p-8 border border-slate-200 dark:border-white/[0.08] shadow-m3-1 transition-colors">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="p-4 rounded-3xl bg-amber-50/80 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/40 text-right shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          <div className="md:col-span-5">
            <select
              ...
              className="w-full p-3 rounded-2xl border border-slate-300 dark:border-white/[0.1] text-xs font-bold text-slate-800 dark:text-white bg-slate-50 dark:bg-[#0E0E0E] focus:ring-2 focus:ring-amber-500 focus:outline-none"
            >
          ...
          <div className="md:col-span-5">
            <input
              ...
              className="w-full p-3 rounded-2xl border border-slate-300 dark:border-white/[0.1] font-mono text-xs font-bold text-slate-800 dark:text-white bg-white dark:bg-[#0E0E0E] focus:ring-2 focus:ring-amber-500 focus:outline-none"
            />
          </div>
      ...
      <div className="bg-white dark:bg-[#0A0A0A] rounded-4xl p-6 sm:p-8 border border-slate-200 dark:border-white/[0.08] shadow-m3-1 space-y-6 transition-colors">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-neutral-400">
                {activeProperty.ward} • PID: <span className="font-mono font-bold text-slate-700 dark:text-neutral-300">{pidInput}</span> • Owner: {user.name}
              </p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 text-xs font-bold border border-emerald-200 dark:border-emerald-800/40 flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0E0E0E] border border-slate-200 dark:border-white/[0.1]">
            <span className="text-slate-500 dark:text-neutral-400 block mb-1">Gross Annual Municipal Demand</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-[#1A1A1A] text-slate-800 dark:text-slate-200 text-xs font-bold transition-colors"
            >
              Past Receipt
            </button>
